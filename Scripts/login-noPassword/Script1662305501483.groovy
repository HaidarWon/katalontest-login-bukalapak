...
WebUI.click(findTestObject('Object Repository/Login/Page_Login ke Akun  Bukalapak/div_password'))

WebUI.setText(findTestObject('Login/Page_Login ke Akun  Bukalapak/input_Lanjut_Password'), '')

WebUI.click(findTestObject('Login/Page_Login ke Akun  Bukalapak/button_Login'))

WebUI.verifyElementText(findTestObject('Login/Alert/p_Password wajib diisi, ya'), 'Password wajib diisi, ya.')
